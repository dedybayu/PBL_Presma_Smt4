        ...
        <div class="modal-body">
            <div class="text-center">
                <img id="profileImage" class="img-thumbnail rounded-circle mb-3"
                    ...
                    src="{{ $mahasiswa->profile_picture ? asset('storage/' . auth()->mahasiswa()->profile_picture) : asset('img/user.png') }}"
                    alt="Profile picture">
            ...
            <div class="form-group">
                ...
                <input value="{{ $mahasiswa->user->username }}" type="text" name="username" id="username" class="form-control"
                    required>
            ...
            <div class="form-group">
                <label>No. Tlp</label>
                <input value="{{ $mahasiswa->no_tlp }}" type="text" name="no_tlp" id="no_tlp" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input value="{{ $mahasiswa->tahun_angkatan }}" type="number" name="tahun_angkatan" id="tahun_angkatan" class="form-control" required>
